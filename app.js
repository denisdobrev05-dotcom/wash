...
const STEPS = [
  ...
  { part: 'a', emoji: '💦', title: 'Изплакни джантата',
    text: 'Свали хлабавата кал с водоструйката.',
    tip: 'Пистолет на 20–30 см от ръбовете.' },
  { part: 'a', emoji: '🧽', title: 'Измий с гъбата',
    text: 'Спици, лице, борд. Без силно търкане.',
    warn: 'Не пипай лицето с общата четка на автомивката — тя дращи.' },
  { part: 'a', emoji: '🪣', title: 'Изплакни гъбата',
    text: 'Топни я в кофата, за да махнеш песъчинките.' },
  { part: 'a', emoji: '💦', title: 'Изплакни джантата',
    text: 'Още веднъж с водоструйката.' },
  { part: 'a', emoji: '🔁', title: 'Другите 3 джанти',
    text: 'Повтори същото за всяка.' },

  // ЧАСТ Б — WetCoat (само на 2–3 месеца)
  { part: 'b', wetcoat: true, emoji: '🧴', title: 'Напръскай WetCoat',
    text: 'Върху мократа джанта, 2–4 пръскания.',
